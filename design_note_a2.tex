...
\todo{The measured table: AUC/MRR/nDCG@5/nDCG@10 per variant per split per
dataset with bootstrap CIs, the three paired 95\% CIs and which of them exclude
zero, and where NRMS lands against A2 Q2's Stage-1 baselines and re-ranker on
the same 200,000 impressions. Figures: \code{nrms\_ablation.png},
\code{nrms\_paired\_ci.png}.}
